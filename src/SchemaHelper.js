...
function SchemaHelper(services) {
  ...
  this._checkInputURL = function (configParams) {
    ...
    } else if (configParams.inputUrl.indexOf("https://datos.canarias.es/api/estadisticas/api/statistical-resources/v1.0/datasets/ISTAC/") !== 0){
    ...
    if (error) {
      DataStudioApp.createCommunityConnector()
        ...
        .setText(
          ...
          "https://datos.canarias.es/api/estadisticas/api/statistical-resources/v1.0/datasets/ISTAC/" +
          "CODIGO_DEL_CUBO"
        )
        .throwException();
    }
